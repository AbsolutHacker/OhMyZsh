...
# commands using sudo #######
    ...
    alias ais="sudo $apt_pref install --install-suggests"
    alias air="sudo $apt_pref install --install-recommends"
    alias aisr="sudo $apt_pref install --install-suggests --install-recommends"
