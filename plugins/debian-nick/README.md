...
| `ais`    | `sudo $apt_pref install --install-suggests`                                            | Command-line tool to install package                                                        |
| `air`    | `sudo $apt_pref install --install-recommends`                                          | Command-line tool to install package                                                        |
| `aisr`   | `sudo $apt_pref install --install-suggests --install-recommends`                       | Command-line tool to install package                                                        |
